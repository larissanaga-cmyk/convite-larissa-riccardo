(() => {
  const gifts = [
    {id:'teste_2', image:'19-contribuicao-livre-pix.jpg', price:2, pt:'TESTE DE PAGAMENTO — remover após a validação', it:'TEST PAGAMENTO — rimuovere dopo la verifica'},
    ...
    {id:'riccardo_certo_150', image:'07-riccardo-certo.jpg', price:150, pt:'Fundo “Riccardo também acha que estava certo” — pela democracia do casamento', it:'Fondo “Anche Riccardo pensa di avere ragione” — per la democrazia matrimoniale'},
    {id:'moto_essencial_300', image:'08-capacete-moto.jpg', price:300, pt:'Ajude a Larissa a sobreviver à próxima compra “essencial” para a moto', it:'Aiuta Larissa a sopravvivere al prossimo acquisto “indispensabile” per la moto'},
    ...
    {id:'delivery_250', image:'10-pizza-delivery.jpg', price:250, pt:'Fundo emergência: ninguém quer cozinhar hoje', it:'Fondo emergenza: oggi nessuno vuole cucinare'},
    {id:'sobremesa_150', image:'11-sobremesa.jpg', price:150, pt:'Patrocine uma sobremesa que os dois juram que vão dividir', it:'Offri un dolce che entrambi giurano di dividere'},
    {id:'brinde_300', image:'12-brinde-vinho.jpg', price:300, pt:'Um brinde para quando nenhum dos dois quiser admitir que estava errado', it:'Un brindisi per quando nessuno dei due vorrà ammettere di aver sbagliato'},
    {id:'filme_200', image:'13-netflix-filme.jpg', price:200, pt:'Ajude o casal a escolher o que assistir em menos de 40 minutos', it:'Aiuta la coppia a scegliere cosa guardare in meno di 40 minuti'},
