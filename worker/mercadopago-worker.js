...
const GIFTS = {
  teste_5: { title: 'Teste de pagamento - convite Larissa e Riccardo', price: 5 },
  ...
  riccardo_certo_150: { title: 'Fundo Riccardo também acha que estava certo', price: 150 },
  moto_essencial_300: { title: 'Próxima compra essencial para a moto', price: 300 },
  promocao_200: { title: 'Não precisava, mas estava em promoção', price: 200 },
  delivery_250: { title: 'Fundo emergência: ninguém quer cozinhar', price: 250 },
  sobremesa_150: { title: 'Sobremesa que juramos que vamos dividir', price: 150 },
  brinde_300: { title: 'Um brinde para ninguém admitir que estava errado', price: 300 },
  filme_200: { title: 'Escolher o que assistir em menos de 40 minutos', price: 200 },
